...
(function() {
...
}, { "./sinon": 2 }], 2: [function(require2, module, exports) {
  "use strict";
  var behavior = require2("./sinon/behavior");
  var createSandbox = require2("./sinon/create-sandbox");
  var extend = require2("./sinon/util/core/extend");
  var fakeTimers = require2("./sinon/util/fake-timers");
  var format = require2("./sinon/util/core/format");
  var nise = require2("nise");
  var Sandbox = require2("./sinon/sandbox");
  var stub = require2("./sinon/stub");
  var promise = require2("./sinon/promise");
  var apiMethods = {
    createSandbox,
    assert: require2("./sinon/assert"),
  ...
  module.exports = api;
}, { "./sinon/assert": 3, "./sinon/behavior": 4, "./sinon/create-sandbox": 7, "./sinon/mock-expectation": 10, "./sinon/promise": 12, "./sinon/restore-object": 17, "./sinon/sandbox": 18, "./sinon/stub": 21, "./sinon/util/core/default-config": 23, "./sinon/util/core/extend": 25, "./sinon/util/core/format": 26, "./sinon/util/fake-timers": 40, "@sinonjs/samsam": 86, "nise": 107 }], 3: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var calledInOrder = require2("@sinonjs/commons").calledInOrder;
  var createMatcher = require2("@sinonjs/samsam").createMatcher;
  var orderByFirstCall = require2("@sinonjs/commons").orderByFirstCall;
  var timesInWords = require2("./util/core/times-in-words");
  var format = require2("./util/core/format");
  var stringSlice = require2("@sinonjs/commons").prototypes.string.slice;
  var globalObject = require2("@sinonjs/commons").global;
...
}, { "./util/core/format": 26, "./util/core/times-in-words": 35, "@sinonjs/commons": 47, "@sinonjs/samsam": 86 }], 4: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var extend = require2("./util/core/extend");
  var functionName = require2("@sinonjs/commons").functionName;
  var nextTick = require2("./util/core/next-tick");
  var valueToString = require2("@sinonjs/commons").valueToString;
  var exportAsyncBehaviors = require2("./util/core/export-async-behaviors");
  var concat = arrayProto.concat;
  var join = arrayProto.join;
...
}, { "./util/core/export-async-behaviors": 24, "./util/core/extend": 25, "./util/core/next-tick": 34, "@sinonjs/commons": 47 }], 5: [function(require2, module, exports) {
  "use strict";
  var walk = require2("./util/core/walk");
  var getPropertyDescriptor = require2("./util/core/get-property-descriptor");
  var hasOwnProperty = require2("@sinonjs/commons").prototypes.object.hasOwnProperty;
  var push = require2("@sinonjs/commons").prototypes.array.push;
...
}, { "./util/core/get-property-descriptor": 29, "./util/core/walk": 38, "@sinonjs/commons": 47 }], 6: [function(require2, module, exports) {
  "use strict";
  var supportsColor = require2("supports-color");
...
}, { "supports-color": 110 }], 7: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var Sandbox = require2("./sandbox");
  var forEach = arrayProto.forEach;
...
}, { "./sandbox": 18, "@sinonjs/commons": 47 }], 8: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var isPropertyConfigurable = require2("./util/core/is-property-configurable");
  var exportAsyncBehaviors = require2("./util/core/export-async-behaviors");
  var extend = require2("./util/core/extend");
  var slice = arrayProto.slice;
  var useLeftMostCallback = -1;
...
}, { "./util/core/export-async-behaviors": 24, "./util/core/extend": 25, "./util/core/is-property-configurable": 32, "@sinonjs/commons": 47 }], 9: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var createProxy = require2("./proxy");
  var nextTick = require2("./util/core/next-tick");
  var slice = arrayProto.slice;
  ...
  function wrapFunc(f) {
    ...
    var fakeInstance = function() {
      ...
      var callback = lastArg && typeof lastArg === "function" ? lastArg : void 0;
...
}, { "./proxy": 16, "./util/core/next-tick": 34, "@sinonjs/commons": 47 }], 10: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var proxyInvoke = require2("./proxy-invoke");
  var proxyCallToString = require2("./proxy-call").toString;
  var timesInWords = require2("./util/core/times-in-words");
  var extend = require2("./util/core/extend");
  var match = require2("@sinonjs/samsam").createMatcher;
  var stub = require2("./stub");
  var assert = require2("./assert");
  var deepEqual = require2("@sinonjs/samsam").deepEqual;
  var format = require2("./util/core/format");
  var valueToString = require2("@sinonjs/commons").valueToString;
...
}, { "./assert": 3, "./proxy-call": 14, "./proxy-invoke": 15, "./stub": 21, "./util/core/extend": 25, "./util/core/format": 26, "./util/core/times-in-words": 35, "@sinonjs/commons": 47, "@sinonjs/samsam": 86 }], 11: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var mockExpectation = require2("./mock-expectation");
  var proxyCallToString = require2("./proxy-call").toString;
  var extend = require2("./util/core/extend");
  var deepEqual = require2("@sinonjs/samsam").deepEqual;
  var wrapMethod = require2("./util/core/wrap-method");
  var usePromiseLibrary = require2("./util/core/use-promise-library");
  var concat = arrayProto.concat;
  ...
  extend(mock, {
    create: function create(object) {
      ...
      var mockObject = extend.nonEnum({}, mock, { object });
  ...
  module.exports = mock;
}, { "./mock-expectation": 10, "./proxy-call": 14, "./util/core/extend": 25, "./util/core/use-promise-library": 36, "./util/core/wrap-method": 39, "@sinonjs/commons": 47, "@sinonjs/samsam": 86 }], 12: [function(require2, module, exports) {
  "use strict";
  var fake = require2("./fake");
  var isRestorable = require2("./util/core/is-restorable");
...
}, { "./fake": 9, "./util/core/is-restorable": 33 }], 13: [function(require2, module, exports) {
  "use strict";
  var push = require2("@sinonjs/commons").prototypes.array.push;
...
}, { "@sinonjs/commons": 47 }], 14: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var match = require2("@sinonjs/samsam").createMatcher;
  var deepEqual = require2("@sinonjs/samsam").deepEqual;
  var functionName = require2("@sinonjs/commons").functionName;
  var sinonFormat = require2("./util/core/format");
  var valueToString = require2("@sinonjs/commons").valueToString;
  var concat = arrayProto.concat;
  var filter = arrayProto.filter;
  var join = arrayProto.join;
...
}, { "./util/core/format": 26, "@sinonjs/commons": 47, "@sinonjs/samsam": 86 }], 15: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var proxyCallUtil = require2("./proxy-call-util");
  var push = arrayProto.push;
  var forEach = arrayProto.forEach;
  var concat = arrayProto.concat;
...
}, { "./proxy-call-util": 13, "@sinonjs/commons": 47 }], 16: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var extend = require2("./util/core/extend");
  var functionToString = require2("./util/core/function-to-string");
  var proxyCall = require2("./proxy-call");
  var proxyCallUtil = require2("./proxy-call-util");
  var proxyInvoke = require2("./proxy-invoke");
  var sinonFormat = require2("./util/core/format");
  var push = arrayProto.push;
...
}, { "./proxy-call": 14, "./proxy-call-util": 13, "./proxy-invoke": 15, "./spy-formatters": 19, "./util/core/extend": 25, "./util/core/format": 26, "./util/core/function-to-string": 27, "@sinonjs/commons": 47 }], 17: [function(require2, module, exports) {
  "use strict";
  var walkObject = require2("./util/core/walk-object");
...
}, { "./util/core/walk-object": 37 }], 18: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var logger = require2("@sinonjs/commons").deprecated;
  var collectOwnMethods = require2("./collect-own-methods");
  var getPropertyDescriptor = require2("./util/core/get-property-descriptor");
  var isPropertyConfigurable = require2("./util/core/is-property-configurable");
  var match = require2("@sinonjs/samsam").createMatcher;
  var sinonAssert = require2("./assert");
  var sinonClock = require2("./util/fake-timers");
  var sinonMock = require2("./mock");
  var sinonSpy = require2("./spy");
  var sinonStub = require2("./stub");
  var sinonFake = require2("./fake");
  var valueToString = require2("@sinonjs/commons").valueToString;
  var fakeServer = require2("nise").fakeServer;
  var fakeXhr = require2("nise").fakeXhr;
  var usePromiseLibrary = require2("./util/core/use-promise-library");
...
}, { "./assert": 3, "./collect-own-methods": 5, "./fake": 9, "./mock": 11, "./spy": 20, "./stub": 21, "./util/core/get-property-descriptor": 29, "./util/core/is-property-configurable": 32, "./util/core/use-promise-library": 36, "./util/fake-timers": 40, "@sinonjs/commons": 47, "@sinonjs/samsam": 86, "nise": 107 }], 19: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var color = require2("./color");
  var match = require2("@sinonjs/samsam").createMatcher;
  var timesInWords = require2("./util/core/times-in-words");
  var sinonFormat = require2("./util/core/format");
  var jsDiff = require2("diff");
  var join = arrayProto.join;
  var map = arrayProto.map;
  var push = arrayProto.push;
  var slice = arrayProto.slice;
...
${join(calls, "\n")}` : "";
...
}, { "./color": 6, "./util/core/format": 26, "./util/core/times-in-words": 35, "@sinonjs/commons": 47, "@sinonjs/samsam": 86, "diff": 93 }], 20: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var createProxy = require2("./proxy");
  var extend = require2("./util/core/extend");
  ...
  var getPropertyDescriptor = require2("./util/core/get-property-descriptor");
  var deepEqual = require2("@sinonjs/samsam").deepEqual;
  var isEsModule = require2("./util/core/is-es-module");
  var proxyCallUtil = require2("./proxy-call-util");
  var walkObject = require2("./util/core/walk-object");
  var wrapMethod = require2("./util/core/wrap-method");
  var valueToString = require2("@sinonjs/commons").valueToString;
  ...
  extend(spy, spyApi);
  module.exports = spy;
}, { "./proxy": 16, "./proxy-call-util": 13, "./util/core/extend": 25, "./util/core/get-property-descriptor": 29, "./util/core/is-es-module": 30, "./util/core/walk-object": 37, "./util/core/wrap-method": 39, "@sinonjs/commons": 47, "@sinonjs/samsam": 86 }], 21: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var behavior = require2("./behavior");
  var behaviors = require2("./default-behaviors");
  var createProxy = require2("./proxy");
  var functionName = require2("@sinonjs/commons").functionName;
  var hasOwnProperty = require2("@sinonjs/commons").prototypes.object.hasOwnProperty;
  var isNonExistentProperty = require2("./util/core/is-non-existent-property");
  var spy = require2("./spy");
  var extend = require2("./util/core/extend");
  var getPropertyDescriptor = require2("./util/core/get-property-descriptor");
  var isEsModule = require2("./util/core/is-es-module");
  var wrapMethod = require2("./util/core/wrap-method");
  var throwOnFalsyObject = require2("./throw-on-falsy-object");
  var valueToString = require2("@sinonjs/commons").valueToString;
  var walkObject = require2("./util/core/walk-object");
  var forEach = arrayProto.forEach;
  var pop = arrayProto.pop;
  ...
  extend(stub, proto);
  module.exports = stub;
}, { "./behavior": 4, "./default-behaviors": 8, "./proxy": 16, "./spy": 20, "./throw-on-falsy-object": 22, "./util/core/extend": 25, "./util/core/get-property-descriptor": 29, "./util/core/is-es-module": 30, "./util/core/is-non-existent-property": 31, "./util/core/walk-object": 37, "./util/core/wrap-method": 39, "@sinonjs/commons": 47 }], 22: [function(require2, module, exports) {
  "use strict";
  var valueToString = require2("@sinonjs/commons").valueToString;
...
}, { "@sinonjs/commons": 47 }], 23: [function(require2, module, exports) {
  "use strict";
  module.exports = {
    injectInto: null,
    properties: [
...
}, { "@sinonjs/commons": 47 }], 25: [function(require2, module, exports) {
  "use strict";
  var arrayProto = require2("@sinonjs/commons").prototypes.array;
  var hasOwnProperty = require2("@sinonjs/commons").prototypes.object.hasOwnProperty;
  var join = arrayProto.join;
...
}, { "@sinonjs/commons": 47 }], 26: [function(require2, module, exports) {
  "use strict";
...
}, { "util": 92 }], 27: [function(require2, module, exports) {
  "use strict";
  ...
  "use strict";
  var getPropertyDescriptor = require2("./get-property-descriptor");
  function isPropertyConfigurable(obj, propName) {
    var propertyDescriptor = getPropertyDescriptor(obj, propName);
    return propertyDescriptor ? propertyDescriptor.configurable : true;
  }
  module.exports = isPropertyConfigurable;
}, { "./get-property-descriptor": 29 }], 33: [function(require2, module, exports) {
  "use strict";
  ...
  "use strict";
  var globalObject = require2("@sinonjs/commons").global;
  var getNextTick = require2("./get-next-tick");
  module.exports = getNextTick(globalObject.process, globalObject.setImmediate);
}, { "./get-next-tick": 28, "@sinonjs/commons": 47 }], 35: [function(require2, module, exports) {
  "use strict";
...
}, { "./get-property-descriptor": 29, "./walk": 38, "@sinonjs/commons": 47 }], 38: [function(require2, module, exports) {
  "use strict";
...
}, { "@sinonjs/commons": 47 }], 39: [function(require2, module, exports) {
  "use strict";
  var getPropertyDescriptor = require2("./get-property-descriptor");
  ...
  module.exports = function wrapMethod(object, property, method) {
    ...
    function checkWrappedMethod(wrappedMethod2) {
      ...
      if (!isFunction(wrappedMethod2)) {
        ...
        var verb = wrappedMethod2.returns ? "stubbed" : "spied on";
...
}, { "./extend": 25, "./get-property-descriptor": 29, "@sinonjs/commons": 47 }], 40: [function(require2, module, exports) {
  "use strict";
  var extend = require2("./core/extend");
  var FakeTimers = require2("@sinonjs/fake-timers");
  var globalObject = require2("@sinonjs/commons").global;
...
}, { "./core/extend": 25, "@sinonjs/commons": 47, "@sinonjs/fake-timers": 59 }], 41: [function(require2, module, exports) {
  "use strict";
...
}, { "./prototypes/array": 49 }], 42: [function(require2, module, exports) {
  "use strict";
  var functionName = require2("./function-name");
...
}, { "./function-name": 45 }], 43: [function(require2, module, exports) {
  "use strict";
...
}, { "./called-in-order": 41, "./class-name": 42, "./deprecated": 43, "./every": 44, "./function-name": 45, "./global": 46, "./order-by-first-call": 48, "./prototypes": 52, "./type-of": 57, "./value-to-string": 58 }], 48: [function(require2, module, exports) {
  "use strict";
...
}, { "./prototypes/array": 49 }], 49: [function(require2, module, exports) {
  "use strict";
  var copyPrototype = require2("./copy-prototype");
  module.exports = copyPrototype(Array.prototype);
}, { "./copy-prototype": 50 }], 50: [function(require2, module, exports) {
  "use strict";
...
}, { "./copy-prototype": 50 }], 52: [function(require2, module, exports) {
  "use strict";
  module.exports = {
...
}, { "./array": 49, "./function": 51, "./map": 53, "./object": 54, "./set": 55, "./string": 56 }], 53: [function(require2, module, exports) {
  "use strict";
  var copyPrototype = require2("./copy-prototype");
  module.exports = copyPrototype(Map.prototype);
}, { "./copy-prototype": 50 }], 54: [function(require2, module, exports) {
  "use strict";
  var copyPrototype = require2("./copy-prototype");
  module.exports = copyPrototype(Object.prototype);
}, { "./copy-prototype": 50 }], 55: [function(require2, module, exports) {
  "use strict";
  var copyPrototype = require2("./copy-prototype");
  module.exports = copyPrototype(Set.prototype);
}, { "./copy-prototype": 50 }], 56: [function(require2, module, exports) {
  "use strict";
  var copyPrototype = require2("./copy-prototype");
  module.exports = copyPrototype(String.prototype);
}, { "./copy-prototype": 50 }], 57: [function(require2, module, exports) {
  "use strict";
  var type = require2("type-detect");
  module.exports = function typeOf(value) {
    return type(value).toLowerCase();
  };
}, { "type-detect": 111 }], 58: [function(require2, module, exports) {
  "use strict";
...
To automatically clean-up native timers, use \`shouldClearNativeTimers\`.`);
...
}, { "@sinonjs/commons": 47, "util": 92 }], 60: [function(require2, module, exports) {
  "use strict";
  var ARRAY_TYPES = [
    Array,
    Int8Array,
...
}, { "./is-matcher": 66 }], 63: [function(require2, module, exports) {
  "use strict";
...
}, { "@sinonjs/commons": 47 }], 65: [function(require2, module, exports) {
  "use strict";
  var typeOf = require2("@sinonjs/commons").typeOf;
...
}, { "@sinonjs/commons": 47 }], 66: [function(require2, module, exports) {
  "use strict";
...
}, { "./matcher-prototype": 68, "@sinonjs/commons": 47 }], 67: [function(require2, module, exports) {
  "use strict";
...
}, { "../deep-equal": 70, "./is-matcher": 66, "@sinonjs/commons": 47 }], 68: [function(require2, module, exports) {
  "use strict";
...
}, { "../create-matcher": 61 }], 69: [function(require2, module, exports) {
  "use strict";
  var functionName = require2("@sinonjs/commons").functionName;
...
}, { "./match-object": 67, "@sinonjs/commons": 47 }], 70: [function(require2, module, exports) {
  "use strict";
  var valueToString = require2("@sinonjs/commons").valueToString;
  ...
  function deepEqualCyclic(actual, expectation, match) {
    ...
    return function deepEqual(actualObj, expectationObj, actualPath, expectationPath) {
      ...
      var isExpectationNonArrayIterable = isIterable(expectation) && !isArrayType(expectation) && !isArguments(expectation);
...
}, { "./get-class": 71, "./identical": 72, "./is-arguments": 73, "./is-array-type": 74, "./is-date": 75, "./is-element": 76, "./is-iterable": 77, "./is-map": 78, "./is-nan": 79, "./is-object": 81, "./is-set": 82, "./is-subset": 83, "@sinonjs/commons": 47 }], 71: [function(require2, module, exports) {
  "use strict";
...
}, { "@sinonjs/commons": 47 }], 72: [function(require2, module, exports) {
  "use strict";
  var isNaN2 = require2("./is-nan");
...
}, { "./is-nan": 79, "./is-neg-zero": 80 }], 73: [function(require2, module, exports) {
  "use strict";
  var getClass = require2("./get-class");
...
}, { "./get-class": 71 }], 74: [function(require2, module, exports) {
  "use strict";
  var functionName = require2("@sinonjs/commons").functionName;
...
}, { "./array-types": 60, "@sinonjs/commons": 47, "type-detect": 111 }], 75: [function(require2, module, exports) {
  "use strict";
...
}, { "@sinonjs/commons": 47 }], 84: [function(require2, module, exports) {
  "use strict";
...
}, { "@sinonjs/commons": 47 }], 85: [function(require2, module, exports) {
  "use strict";
  var valueToString = require2("@sinonjs/commons").valueToString;
...
}, { "./create-matcher": 61, "./deep-equal": 70, "./is-array-type": 74, "./is-subset": 83, "@sinonjs/commons": 47, "type-detect": 111 }], 86: [function(require2, module, exports) {
  "use strict";
  var identical = require2("./identical");
  var isArguments = require2("./is-arguments");
  var isElement = require2("./is-element");
...
}, { "./create-matcher": 61, "./deep-equal": 70, "./identical": 72, "./is-arguments": 73, "./is-element": 76, "./is-map": 78, "./is-neg-zero": 80, "./is-set": 82, "./match": 85 }], 87: [function(require2, module, exports) {
  var encoding = require2("./lib/encoding.js");
  module.exports = {
    TextEncoder: encoding.TextEncoder,
    TextDecoder: encoding.TextDecoder
  };
}, { "./lib/encoding.js": 89 }], 88: [function(require2, module, exports) {
  (function(global2) {
    "use strict";
  ...
  (function(global2) {
    ...
    if (typeof module !== "undefined" && module.exports && !global2["encoding-indexes"]) {
      global2["encoding-indexes"] = require2("./encoding-indexes.js")["encoding-indexes"];
    }
    ...
    if (!global2["TextEncoder"])
      global2["TextEncoder"] = TextEncoder2;
...
}, { "./encoding-indexes.js": 88 }], 90: [function(require2, module, exports) {
...
}, { "./support/isBuffer": 91, "inherits": 90 }], 93: [function(require2, module, exports) {
  ...
  module.exports = get;
}, {}], 96: [function(require2, module, exports) {
  "use strict";
...
}, {}], 97: [function(require2, module, exports) {
  "use strict";
  var Event = require2("./event");
  function CustomEvent2(type, customData, target) {
    this.initEvent(type, false, false, target);
    this.detail = customData.detail || null;
  }
  CustomEvent2.prototype = new Event();
  CustomEvent2.prototype.constructor = CustomEvent2;
  module.exports = CustomEvent2;
}, { "./event": 99 }], 98: [function(require2, module, exports) {
  "use strict";
  ...
  var EventTarget = {
    ...
    removeEventListener: function removeEventListener(event, listener, providedOptions) {
      ...
      var options = flattenOptions(providedOptions);
      this.eventListeners[event] = this.eventListeners[event].filter(not(hasListenerFilter(listener, options.capture)));
    },
    dispatchEvent: function dispatchEvent(event) {
      ...
      var self2 = this;
      var type = event.type;
      var listeners = self2.eventListeners[type];
      self2.eventListeners[type] = listeners.filter(function(listenerSpec) {
        return !listenerSpec.once;
      });
      listeners.forEach(function(listenerSpec) {
        var listener = listenerSpec.listener;
        if (typeof listener === "function") {
          listener.call(self2, event);
        } else {
...
}, {}], 99: [function(require2, module, exports) {
  "use strict";
...
}, {}], 100: [function(require2, module, exports) {
  "use strict";
  module.exports = {
    Event: require2("./event"),
    ProgressEvent: require2("./progress-event"),
    CustomEvent: require2("./custom-event"),
    EventTarget: require2("./event-target")
  };
}, { "./custom-event": 97, "./event": 99, "./event-target": 98, "./progress-event": 101 }], 101: [function(require2, module, exports) {
  "use strict";
  var Event = require2("./event");
  function ProgressEvent2(type, progressEventRaw, target) {
    this.initEvent(type, false, false, target);
    this.loaded = typeof progressEventRaw.loaded === "number" ? progressEventRaw.loaded : null;
    this.total = typeof progressEventRaw.total === "number" ? progressEventRaw.total : null;
    this.lengthComputable = Boolean(progressEventRaw.total);
  }
  ProgressEvent2.prototype = new Event();
  ProgressEvent2.prototype.constructor = ProgressEvent2;
  module.exports = ProgressEvent2;
}, { "./event": 99 }], 102: [function(require2, module, exports) {
  "use strict";
  var FakeTimers = require2("@sinonjs/fake-timers");
  var fakeServer = require2("./index");
  function Server() {
  }
...
}, { "./index": 103, "@sinonjs/fake-timers": 59 }], 103: [function(require2, module, exports) {
  "use strict";
  var fakeXhr = require2("../fake-xhr");
  var push = [].push;
  var log = require2("./log");
  var configureLogError = require2("../configure-logger");
  var pathToRegexp = require2("path-to-regexp");
  ...
  function responseArray(handler) {
    ...
    if (typeof response[2] !== "string") {
      if (!supportsArrayBuffer) {
        throw new TypeError(`Fake server response body should be a string, but was ${typeof response[2]}`);
      } else if (!(response[2] instanceof ArrayBuffer)) {
        throw new TypeError(`Fake server response body should be a string or ArrayBuffer, but was ${typeof response[2]}`);
      }
    }
    return response;
  }
  function getDefaultWindowLocation() {
    ...
    winloc.host = winloc.hostname + (String(winloc.port) === "80" ? "" : `:${winloc.port}`);
    return winloc;
  }
  ...
  function matchOne(response, reqMethod, reqUrl) {
    ...
    var matchUrl = !url || url === reqUrl || typeof url.test === "function" && url.test(reqUrl) || typeof url === "function" && url(reqUrl) === true;
    ...
    configure: function(config) {
      ...
      Object.keys(config).forEach(function(setting) {
        if (setting in allowlist) {
          self2[setting] = config[setting];
        }
      });
      self2.logError = configureLogError(config);
    },
...
}, { "../configure-logger": 96, "../fake-xhr": 106, "./log": 104, "path-to-regexp": 108 }], 104: [function(require2, module, exports) {
  "use strict";
  var inspect = require2("util").inspect;
...
`;
  ...
  module.exports = log;
}, { "util": 92 }], 105: [function(require2, module, exports) {
  "use strict";
...
}, {}], 106: [function(require2, module, exports) {
  "use strict";
  var GlobalTextEncoder = typeof TextEncoder !== "undefined" ? TextEncoder : require2("@sinonjs/text-encoding").TextEncoder;
  var globalObject = require2("@sinonjs/commons").global;
  var configureLogError = require2("../configure-logger");
  var sinonEvent = require2("../event");
  var extend = require2("just-extend");
  var supportsProgress = typeof ProgressEvent !== "undefined";
  var supportsCustomEvent = typeof CustomEvent !== "undefined";
  var supportsFormData = typeof FormData !== "undefined";
  var supportsArrayBuffer = typeof ArrayBuffer !== "undefined";
  var supportsBlob = require2("./blob").isSupported;
  ...
  function EventTargetHandler() {
    ...
    function addEventListener(eventName) {
      self2.addEventListener(eventName, function(event) {
        var listener = self2[`on${eventName}`];
  ...
  function verifyResponseBodyType(body, responseType) {
    ...
    if (responseType === "arraybuffer") {
      if (!isString && !(body instanceof ArrayBuffer)) {
        error = new Error(`Attempted to respond to fake XMLHttpRequest with ${body}, which is not a string or ArrayBuffer.`);
        error.name = "InvalidBodyException";
      }
    } else if (responseType === "blob") {
      if (!isString && !(body instanceof ArrayBuffer) && supportsBlob && !(body instanceof Blob)) {
        error = new Error(`Attempted to respond to fake XMLHttpRequest with ${body}, which is not a string, ArrayBuffer, or Blob.`);
        error.name = "InvalidBodyException";
      }
    } else if (!isString) {
      error = new Error(`Attempted to respond to fake XMLHttpRequest with ${body}, which is not a string.`);
      error.name = "InvalidBodyException";
    }
    if (error) {
      throw error;
  ...
  function fakeXMLHttpRequestFor(globalScope) {
    ...
    sinonXhr.supportsTimeout = sinonXhr.supportsXHR && "timeout" in new sinonXhr.GlobalXMLHttpRequest();
    ...
    FakeXMLHttpRequest.defake = function defake(fakeXhr, xhrArgs) {
      ...
      var stateChangeStart = function() {
        ...
        if (xhr.readyState === FakeXMLHttpRequest.DONE && (xhr.responseType === "" || xhr.responseType === "document")) {
      ...
      var stateChange = function stateChange2() {
        stateChangeStart();
        stateChangeEnd();
      };
    ...
    function requestErrorSteps(xhr) {
      ...
      xhr.requestHeaders = {};
      xhr.responseHeaders = {};
      if (xhr.readyState !== FakeXMLHttpRequest.UNSENT && xhr.sendFlag && xhr.readyState !== FakeXMLHttpRequest.DONE) {
      ...
      if (text !== "") {
        try {
          if (typeof DOMParser !== "undefined") {
            ...
            var parsererrorNS = "";
            try {
              var parsererrors = parser.parseFromString("INVALID", "text/xml").getElementsByTagName("parsererror");
            ...
            return result.getElementsByTagNameNS(parsererrorNS, "parsererror").length ? null : result;
          }
      ...
      send: function send(data) {
        ...
        if (sinonXhr.supportsTimeout && typeof setInterval.clock === "object" && typeof Date.clock === "object") {
          ...
          var clearIntervalId = setInterval(function() {
            if (self2.readyState === FakeXMLHttpRequest.UNSENT || self2.readyState === FakeXMLHttpRequest.DONE) {
              clearInterval(clearIntervalId);
            } else if (typeof self2.timeout === "number" && self2.timeout > 0) {
              if (Date.now() >= initiatedTime + self2.timeout) {
                self2.triggerTimeout();
                clearInterval(clearIntervalId);
              }
            }
          }, 1);
...
}, { "../configure-logger": 96, "../event": 100, "./blob": 105, "@sinonjs/commons": 47, "@sinonjs/text-encoding": 87, "just-extend": 94 }], 107: [function(require2, module, exports) {
  "use strict";
  module.exports = {
    fakeServer: require2("./fake-server"),
    fakeServerWithClock: require2("./fake-server/fake-server-with-clock"),
    fakeXhr: require2("./fake-xhr")
  };
}, { "./fake-server": 103, "./fake-server/fake-server-with-clock": 102, "./fake-xhr": 106 }], 108: [function(require2, module, exports) {
...
}, { "isarray": 109 }], 109: [function(require2, module, exports) {
  module.exports = Array.isArray || function(arr) {
    return Object.prototype.toString.call(arr) == "[object Array]";
  };
}, {}], 110: [function(require2, module, exports) {
  "use strict";
  module.exports = {
    stdout: false,
    stderr: false
  };
}, {}], 111: [function(require2, module, exports) {
  (function(global2, factory) {
...
var sinon_esm_default = sinon;
var _leakThreshold = sinon.leakThreshold;
var _assert = sinon.assert;
var _serverPrototype = sinon.serverPrototype;
var _getFakes = sinon.getFakes;
var _getRestorers = sinon.getRestorers;
var _createStubInstance = sinon.createStubInstance;
var _inject = sinon.inject;
var _mock = sinon.mock;
var _reset = sinon.reset;
var _resetBehavior = sinon.resetBehavior;
var _resetHistory = sinon.resetHistory;
var _restore = sinon.restore;
var _restoreContext = sinon.restoreContext;
var _replace = sinon.replace;
var _replaceGetter = sinon.replaceGetter;
var _replaceSetter = sinon.replaceSetter;
var _spy = sinon.spy;
var _stub = sinon.stub;
var _fake = sinon.fake;
var _useFakeTimers = sinon.useFakeTimers;
var _verify = sinon.verify;
var _verifyAndRestore = sinon.verifyAndRestore;
var _useFakeServer = sinon.useFakeServer;
var _useFakeXMLHttpRequest = sinon.useFakeXMLHttpRequest;
var _usingPromise = sinon.usingPromise;
var _createSandbox = sinon.createSandbox;
var _match = sinon.match;
var _restoreObject = sinon.restoreObject;
var _expectation = sinon.expectation;
var _defaultConfig = sinon.defaultConfig;
var _setFormatter = sinon.setFormatter;
var _timers = sinon.timers;
var _xhr = sinon.xhr;
var _FakeXMLHttpRequest = sinon.FakeXMLHttpRequest;
var _fakeServer = sinon.fakeServer;
var _fakeServerWithClock = sinon.fakeServerWithClock;
var _createFakeServer = sinon.createFakeServer;
var _createFakeServerWithClock = sinon.createFakeServerWithClock;
var _addBehavior = sinon.addBehavior;
var _promise = sinon.promise;

// dep:sinon
var sinon_default = sinon_esm_default;
export {
  _FakeXMLHttpRequest as FakeXMLHttpRequest,
  _addBehavior as addBehavior,
  _assert as assert,
  _createFakeServer as createFakeServer,
  _createFakeServerWithClock as createFakeServerWithClock,
  _createSandbox as createSandbox,
  _createStubInstance as createStubInstance,
  sinon_default as default,
  _defaultConfig as defaultConfig,
  _expectation as expectation,
  _fake as fake,
  _fakeServer as fakeServer,
  _fakeServerWithClock as fakeServerWithClock,
  _getFakes as getFakes,
  _getRestorers as getRestorers,
  _inject as inject,
  _leakThreshold as leakThreshold,
  _match as match,
  _mock as mock,
  _promise as promise,
  _replace as replace,
  _replaceGetter as replaceGetter,
  _replaceSetter as replaceSetter,
  _reset as reset,
  _resetBehavior as resetBehavior,
  _resetHistory as resetHistory,
  _restore as restore,
  _restoreContext as restoreContext,
  _restoreObject as restoreObject,
  _serverPrototype as serverPrototype,
  _setFormatter as setFormatter,
  _spy as spy,
  _stub as stub,
  _timers as timers,
  _useFakeServer as useFakeServer,
  _useFakeTimers as useFakeTimers,
  _useFakeXMLHttpRequest as useFakeXMLHttpRequest,
  _usingPromise as usingPromise,
  _verify as verify,
  _verifyAndRestore as verifyAndRestore,
  _xhr as xhr
};
/* Sinon.JS 14.0.0, 2022-05-07, @license BSD-3 */
